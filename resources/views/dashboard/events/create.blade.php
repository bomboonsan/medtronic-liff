            ...
            <div class="dashboard-card">
                ...
                <form action="{{ route('events.store') }}" method="POST" class="form-create-post" enctype="multipart/form-data">
                    ...
                    <div class="form-control w-full mb-1">
                        ...
                        <input type="text" placeholder="ระบุหัวข้อกิจกรรม" class="input input-bordered w-full" id="title" name="title" required />
                    </div>
                    ...
                    <div class="flex gap-5">
                        <div class="flex-auto">
                            <div class="form-control w-full mb-3">
                                ...
                                <input type="datetime-local" class="input input-bordered w-full" id="start_date" name="start_date" required />
                            </div>
                        </div>
                        <div class="flex-auto">
                            <label for="end_date" class="label">
                              ...
                              <input type="datetime-local" class="input input-bordered w-full" id="end_date" name="end_date" required />
                        </div>
                    </div>            
